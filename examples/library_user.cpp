...
int main() {
    ...
    std::cout << "Is string numeric? " << examples::math_utils::is_numeric_v<std::string> << std::endl;
    ...
    std::cout << "Chained operation result (filter > 25, then sqrt, then mean): " 
              << chained_mean << std::endl;
    ...
    std::cout << "Move operation successful: " << (shared_lib3->identifier() == identifier_before) << std::endl;
